...
class BaseTheme(ABC):
    ...
    custom_bg_dir_path: str = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))), 'ArkanaBundler\\assets\\img\\bg\\1080')  # put your custom background here if bg has been defined in songlist

    slogan = 'Generated by ArcaeaChartRender'  # in the bottom right corner of the image
    ...
    font_Kazesawa_Regular_54 = ImageFont.truetype('./assets/Fonts/ShangguSans-Bold.ttf', 54)
    # for artist / chart designer / jacket designer at text area
    font_SourceHanMonoSC_Regular_40 = ImageFont.truetype('./assets/Fonts/ShangguSans-Bold.ttf', 40)
    # for statistics at text area
    font_SourceHanMonoSC_Regular_34 = ImageFont.truetype('./assets/Fonts/ShangguSans-Bold.ttf', 34)
